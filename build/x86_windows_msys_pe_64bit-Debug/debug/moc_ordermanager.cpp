...
QT_MOC_LITERAL(1, 13, 8), // "newOrder"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "Order"
QT_MOC_LITERAL(4, 29, 5) // "order"

    },
    "OrderManager\0newOrder\0\0Order\0order"
};
...
void OrderManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newOrder((*reinterpret_cast< const Order(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (OrderManager::*)(const Order & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OrderManager::newOrder)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OrderManager::newOrder(const Order & _t1)
{
