...
QT_MOC_LITERAL(1, 12, 14), // "updateDistance"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "distance"
QT_MOC_LITERAL(4, 37, 5), // "total"
QT_MOC_LITERAL(5, 43, 11), // "updateSpeed"
QT_MOC_LITERAL(6, 55, 5), // "speed"
QT_MOC_LITERAL(7, 61, 9), // "showOrder"
QT_MOC_LITERAL(8, 71, 5), // "Order"
QT_MOC_LITERAL(9, 77, 5), // "order"
QT_MOC_LITERAL(10, 83, 10) // "updateGame"

    },
    "GameManager\0updateDistance\0\0distance\0"
    "total\0updateSpeed\0speed\0showOrder\0"
    "Order\0order\0updateGame"
};
...
void GameManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateDistance((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->updateSpeed((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->showOrder((*reinterpret_cast< const Order(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameManager::updateDistance)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameManager::updateSpeed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (GameManager::*)(const Order & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameManager::showOrder)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void GameManager::updateDistance(int _t1, int _t2)
{
...
// SIGNAL 1
void GameManager::updateSpeed(int _t1)
{
...
// SIGNAL 2
void GameManager::showOrder(const Order & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
